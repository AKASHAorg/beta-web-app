...
class TransactionService extends BaseService {
    constructor () {
        super();
        this.clientManager = channel.instance.client.tx.manager;
    }
    ...
    addToQueue = ({ txs, onError, onSuccess }) => {
        const serverChannel = channel.instance.server.tx.addToQueue;
        const clientChannel = channel.instance.client.tx.addToQueue;
    ...
    emitMined = ({ watch, options, onError, onSuccess }) => {
        const serverChannel = channel.instance.server.tx.emitMined;
        const clientChannel = channel.instance.client.tx.emitMined;
