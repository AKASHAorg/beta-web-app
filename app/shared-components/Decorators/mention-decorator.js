...
let addressOfClient;
let addressOfServer;
let getProfileDataClient;
let getProfileDataServer;

class MentionComponent extends Component {

    constructor (props) {
        super(props);
        existsClient = channel.instance.client.registry.profileExists;
        existsServer = channel.instance.server.registry.profileExists;
        addressOfClient = channel.instance.client.registry.addressOf;
        addressOfServer = channel.instance.server.registry.addressOf;
        getProfileDataClient = channel.instance.client.profile.getProfileData;
        getProfileDataServer = channel.instance.server.profile.getProfileData;
        existsServer.enable();
